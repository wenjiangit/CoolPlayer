...
public class LocalRecordDataSource implements RecordDataSource {
    ...
    public LocalRecordDataSource(@NonNull RecordDao recordDao, @NonNull AppExecutors appExecutors) {
    ...
    public static RecordDataSource getInstance() {
        if (sInstance == null) {
            synchronized (LocalRecordDataSource.class) {
                if (sInstance == null) {
                    sInstance = new LocalRecordDataSource(PlayerDatabase.getInstance().recordDao(), AppExecutors.getInstance());
                }
            }
        }
        return sInstance;

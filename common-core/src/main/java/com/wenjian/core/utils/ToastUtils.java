...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * Utils.getAppContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(Utils.getAppContext().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(Utils.getAppContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(Utils.getAppContext());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) Utils.getAppContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);

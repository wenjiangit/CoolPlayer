...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        return Utils.getAppContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return Utils.getAppContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float getScreenDensity() {
        return Utils.getAppContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return Utils.getAppContext().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return Utils.getAppContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(Utils.getAppContext().getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, duration);
    }
    ...
    public static int getSleepDuration() {
        try {
            return Settings.System.getInt(Utils.getAppContext().getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT);
    ...
    public static boolean isTablet() {
        return (Utils.getAppContext().getResources().getConfiguration().screenLayout

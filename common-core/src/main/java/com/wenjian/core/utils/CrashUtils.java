...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = Utils.getAppContext().getPackageManager().getPackageInfo(Utils.getAppContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && Utils.getAppContext().getExternalCacheDir() != null) {
            defaultDir = Utils.getAppContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        } else {
            defaultDir = Utils.getAppContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
